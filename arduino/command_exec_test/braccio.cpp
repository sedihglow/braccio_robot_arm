...
/* 
 * NOTE: The variables below were decalred as extern and initalized causing a
 * compiler warning. Changed them from extern and everything seems to run fine.
 */
int step_base = 0;
...
int _Braccio::ServoMovement(int stepDelay, int vBase, int vShoulder, int vElbow,int vWrist_ver, int vWrist_rot, int vgripper) {
	...
	{			
        ...
        /*
         * NOTE: For next two if blocks.
         * I am note sure why vWrist_ver is being compared to step_wrist_rot
         * and vWrist_rot is being compared to setp_wrist_ver. It would make
